...
public class ProofAnnotator {
    static List<AnnotatedStatement> getAnnotatedProof(List<Statement> context, List<AnnotatedStatement> proof) throws AnnotatorException {

        Map<String, Integer> contextLines = new HashMap<>(); // lookup map of context lines and their numbers
        Map<String, Integer> proofLines = new HashMap<>(); // lookup map of proof lines and their numbers

        Map<String, Integer> needAlpha = new HashMap<>(); // two maps for
        Map<String, MPPair> betas = new HashMap<>(); // modus ponens

        List<AnnotatedStatement> annotatedProof = new ArrayList<>();
