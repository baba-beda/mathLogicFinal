...
public class LogicParser extends Parser {
	...
	public static class ConjunctionContext extends ParserRuleContext {
		...
		public NegationContext n1;
		public NegationContext n2;
	...
	private ConjunctionContext conjunction(int _p) throws RecognitionException {
		...
		try {
			...
			{
			setState(35);
			((ConjunctionContext)_localctx).n1 = negation();
			((ConjunctionContext)_localctx).value =  ((ConjunctionContext)_localctx).n1.value;
			}
			_ctx.stop = _input.LT(-1);
			setState(45);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					match(AND);
					setState(40);
					((ConjunctionContext)_localctx).n2 = negation();
					((ConjunctionContext)_localctx).value =  new Conjunction(((ConjunctionContext)_localctx).c.value, ((ConjunctionContext)_localctx).n2.value);
					}
					} 
				}
				setState(47);
	...
	public final NegationContext negation() throws RecognitionException {
		...
		try {
			...
			case VAR:
				...
				{
				setState(48);
				((NegationContext)_localctx).v = variable();
				((NegationContext)_localctx).value =  ((NegationContext)_localctx).v.value;
				}
				break;
			case NOT:
				enterOuterAlt(_localctx, 2);
				...
				match(NOT);
				setState(52);
				((NegationContext)_localctx).n = negation();
				((NegationContext)_localctx).value =  new Negation(((NegationContext)_localctx).n.value);
				}
				break;
			case OB:
				...
				match(OB);
				setState(56);
				((NegationContext)_localctx).e = expression();
				setState(57);
				match(CB);
				((NegationContext)_localctx).value =  ((NegationContext)_localctx).e.value;
				}
				break;
			default:
